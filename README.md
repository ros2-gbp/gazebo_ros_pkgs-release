## gazebo_ros_pkgs (rolling) - 3.9.0-1

The packages in the `gazebo_ros_pkgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling gazebo_ros_pkgs` on `Mon, 27 Jan 2025 18:37:24 -0000`
...
## gazebo_ros_pkgs (humble) - 3.9.0-1

The packages in the `gazebo_ros_pkgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble gazebo_ros_pkgs` on `Mon, 27 Jan 2025 18:21:31 -0000`
...
## gazebo_ros_pkgs (rolling) - 3.7.0-1

The packages in the `gazebo_ros_pkgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling gazebo_ros_pkgs` on `Mon, 13 Jun 2022 23:49:33 -0000`
...
## gazebo_ros_pkgs (humble) - 3.7.0-1

The packages in the `gazebo_ros_pkgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble gazebo_ros_pkgs` on `Mon, 13 Jun 2022 23:46:18 -0000`
...
## gazebo_ros_pkgs (humble) - 3.6.0-1
